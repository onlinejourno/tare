...
// structured score output. Openness in particular must use the ONE canonical
// scorer exported by openness.js (access 35% / participation 35% / aiEditorial
// 30%, hard-paywall access penalty −60) — not a drifted per-mode copy.
